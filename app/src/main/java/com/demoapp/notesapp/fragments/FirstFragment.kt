...
import com.demoapp.notesapp.adapter.NoteAdapter
import com.demoapp.notesapp.databinding.FragmentFirstBinding
import com.demoapp.notesapp.model.Note
import com.demoapp.notesapp.viewmodel.NoteViewModel


class FirstFragment : Fragment(R.layout.fragment_first), SearchView.OnQueryTextListener,MenuProvider {

    private var firstBinding : FragmentFirstBinding? =null
    private val binding get() = firstBinding!!
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addNoteFab.setOnClickListener{
            it.findNavController().navigate(R.id.action_firstFragment_to_addNoteFragment)
        }
    }
